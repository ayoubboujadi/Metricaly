/**
 * See https://github.com/fetrarij/ngx-daterangepicker-material/blob/master/src/daterangepicker/daterangepicker.directive.ts for original code
 * Imported from the ngx-daterangepicker-material
 */
...
import { DaterangeInputPickerComponent } from './daterange-input-picker.component';
const moment = _moment;

@Directive({
  selector: 'input[ngxDaterangepickerMd2]',
  host: {
    '(keyup.esc)': 'hide()',
    '(blur)': 'onBlur()',
    '(click)': 'open()',
...
export class DaterangepickerDirective implements OnInit, OnChanges, DoCheck {
  public picker: DaterangeInputPickerComponent;
  ...
  constructor(
    ...
    this.drops = 'down';
    this.opens = 'auto';
    const componentFactory = this._componentFactoryResolver.resolveComponentFactory(DaterangeInputPickerComponent);
    viewContainerRef.clear();
    const componentRef = viewContainerRef.createComponent(componentFactory);
    this.picker = (<DaterangeInputPickerComponent>componentRef.instance);
